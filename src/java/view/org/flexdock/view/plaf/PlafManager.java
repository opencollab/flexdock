...
import org.flexdock.view.plaf.mappings.PlafMappingFactory;
...
public class PlafManager {
	...
	public static void setPreferredTheme(String themeName, boolean reload) {
		...
		// this will handle the case where we switch from null to something else, 
		// vice versa, or a new string value
		boolean themeChanged = oldPref!=newPref && (oldPref==null || newPref==null || !oldPref.equals(newPref));
	...
	public static ComponentUI getUI(JComponent target) {
		return target==null? null: (ComponentUI)UI_DEFAULTS.get(target.getClass());
	}
